...
class EncodeFormat(
    ...
    val format: AudioFormat = EncodeFormatBuilder.DEFAULT_AUDIO_FORMAT,
    ...
    companion object {
        ...
        fun create(config: RecorderConfig, audioRecord: AudioRecord): EncodeFormat {
            return EncodeFormatBuilder.create(config, audioRecord)
        }
    }
}

private object EncodeFormatBuilder {

    val DEFAULT_AUDIO_FORMAT: AudioFormat = AudioFormat.Builder().build()
